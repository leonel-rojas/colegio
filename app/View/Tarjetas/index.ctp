...
<div class="tarjetas index">
	...
	<tr>
		...
		<td><?php echo h($tarjeta['Tarjeta']['codigo']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($tarjeta['Alumno']['id'], array('controller' => 'alumnos', 'action' => 'view', $tarjeta['Alumno']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($tarjeta['Periodo']['id'], array('controller' => 'periodos', 'action' => 'view', $tarjeta['Periodo']['id'])); ?>
		</td>
		<td class="actions">
