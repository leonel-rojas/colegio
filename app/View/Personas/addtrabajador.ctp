...
<div class="col-md-12">
	<div class="panel">
          ...
          <div role="alert" class="gritter-item-wrapper with-icon send-o success mb10">
              <div class="gritter-item">
                <div class="gritter-without-image">
                  <span class="gritter-title"><label class="label label-warning">Completa</label> el siguiente formulario ( 1 / 3 )</span>
                </div>
        ...
        <br><br>
				<h4 class="panel-title">DATOS PERSONALES DEL NUEVO USUARIO</h4>
