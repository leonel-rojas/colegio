...
<div class="panel">
	<div class="panel-heading">
		<div class="text-right">
			<a href="/colegio/egresos/indicarFechaServicios"><button class="btn btn-info btn-quirk">Volver <i class="fa fa-mail-reply"></i></button></a>
			<a href="#" onclick="window.open('/colegio/egresos/reporteRangoServicios/<?php echo $desde.'/'.$hasta.'/'.$detalle ?>')"><button class="btn btn-danger btn-quirk">Imprimir <i class="fa fa-file-pdf-o"></i></button></a>
		...
		<h4 class="panel-title">PAGOS DE SERVICIOS REALIZADOS
			...
			<text class="text-success"> FILTRAR </text>
