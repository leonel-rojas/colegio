...
<div class="panel">
	<div class="panel-heading">
		<div class="text-right">
			<a href="/colegio/egresos/indicarFecha"><button class="btn btn-info btn-quirk">Volver <i class="fa fa-mail-reply"></i></button></a>
			<a href="#" onclick="window.open('/colegio/egresos/reporteRangoPersonal/<?php echo $rango ?>')"><button class="btn btn-danger btn-quirk">Imprimir <i class="fa fa-file-pdf-o"></i></button></a>
